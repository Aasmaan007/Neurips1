...
class Args:
   ...
   lambda_kl_final_frac: float = 0.5
...
if __name__ == "__main__":
   ...
   run_name = f"{args.env_id}_{args.exp_name}_{args.seed}_{args.lambda_kl_init}_{args.lambda_kl_final_frac}_sacconfigwithentropy{int(time.time())}"
   if args.track:
       import wandb
       ...
       if global_step > args.learning_starts:
           ...
           # ------- start replacement block -------
                ...
                #    qmeta_scaled_rep = qmeta_rep * scale   # [B*K]
                   ...
                   qmeta_scaled_rep = qmeta_rep *  scale + shift
