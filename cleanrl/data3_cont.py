...
from cleanrl.diayn.models_cont import Discriminator, Critic, Actor
...
class Args:
    ...
    model_path_disc: str = "runs/checkpoints/diayn/Hopper-v4__diayn__1__2025-08-17_00-44-52__1755371692/latest.pth"
    model_path_qnet: str = "runs/checkpoints/qtargetmaml/Hopper-v4__q_online__1__2025-08-19_00-13-10__1755542590/latest.pth"
...
if __name__ == "__main__":
    ...
    q_net = Critic(env, args.n_skills_selected).to(device)
    ...
    actor.load_state_dict(checkpoint_qnet["actor_state_dict"])
    discriminator.load_state_dict(checkpoint_disc["discriminator_state_dict"])

    allowed_skills = [4, 5, 8, 9, 19, 24]
    ...
    while global_step < args.total_timesteps:
        ...
        for t in range(args.max_timesteps+5):
            ...
            if global_step < args.learning_starts:
                ...
                state_tensor = torch.tensor(obs_aug, dtype=torch.float32).unsqueeze(0).to(device)
                with torch.no_grad():
            ...
            maml_training_data.append((obs.copy(), action))
