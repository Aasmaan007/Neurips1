...
def train_dqn_online(q_network, target_network, discriminator, data, device, args, global_step, 
    ...
    # 4) Return same tuple signature
    return critic_loss, current_q.detach(), intrinsic_rewards, logq_z.detach(), td_target, next_q.detach()
